...
# main
#
# modis_vcf/view/combineBandsCLV.py -o /explore/nobackup/projects/ilab/data/MODIS/MODIS_VCF/tiles
# /explore/nobackup/people/rlgill/SystemTesting/modis-vcf/
# /explore/nobackup/projects/ilab/data/MODIS/MODIS_VCF/tiles
# -----------------------------------------------------------------------------
def main():
